...
:root {
  ...
  --color-background-avatar-gen-ai-0o7qg2:radial-gradient(circle farthest-corner at top right, #b8e7ff 0%, #0099ff 25%, #5c7fff 40% , #8575ff 60%, #962eff 80%);
  --color-background-avatar-default-rci9zy:#424650;
  --color-text-avatar-jddpvm:#ffffff;
  --color-background-loading-bar-gen-ai-c53ukr:linear-gradient(90deg, #b8e7ff 0%, #0099ff 10%, #5c7fff 24%, #8575ff 50%, #962eff 76%, #0099ff 90%, #b8e7ff 100%);
